...
// const a = [1, 2, 3, 4];
// const test = a.map((val, index, arr) => {
//   console.log(val);
//   return val + 2;
// });
// console.log("1", a, test);
...
// const { telephon } = person.testData;

// console.log(telephon);

// if (age > 0) {
//   console.log("Человек по имени, сейчас имеет возраст ");
// } else {
//   console.log("Вообщето это уже будующее");
// }
...
// a || console.log("Человек по имени, сейчас имеет возраст ");

var sports = ["футбол", undefined, "футбол"];
var total = sports.push("американский футбол");
